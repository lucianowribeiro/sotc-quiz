...
function ResultWidget({ results }) {
  ...
  const imageOK = 'https://media.giphy.com/media/g9582DNuQppxC/giphy.gif';
  const imagenotOK = 'https://media1.tenor.com/images/d2d2efba9ed151664d2b540df8108d67/tenor.gif?itemid=16269483';
  return (
    <Widget>
      <Widget.Header>
        {'Hora da verdade '}
...
function QuestionWidget({
  ...
  return (
    <Widget>
      <Widget.Header>
        <Link href="/">
          <Image src="/back.svg" alt="back" width="40%" height="20%" />
        </Link>
        <h3>
